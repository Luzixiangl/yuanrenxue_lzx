...
class Connection(object):
    ...
    def __init__(self, host, database, user=None, password=None,
                 port=0,
                 max_idle_time=7 * 3600,        # max_idle_time mysql默认闲置连接8小时即断掉该连接，这儿默认设置7小时，即每隔7小时重新连接以此保持持续连接mysql
                 connect_timeout=10,
    ...
    def reconnect(self):
        ...
        self.close()        # 先尝试关闭之前的连接
        self._db = pymysql.connect(**self._db_args)
        self._db.autocommit(True)   # 设置自动提交
