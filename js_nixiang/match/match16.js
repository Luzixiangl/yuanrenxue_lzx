...
MATCH_SDK_16 = function(time) {
    ...
    window[u(208)] = function (e) {
        ...
        for (var o, a, s, l = 0, c = []; l < e[t(261)];) {
            switch (a = e[t(237)](l),
                ...
                case 0:
                    // 投毒！！！！！
                    // 在web下，delete window和 delete document并不会生效，但在node下可以。因此将delete代码删除
                    // delete window,
                    //     delete document,
                ...
                case 1:
                    // 投毒！！！！！
                    // 在node环境下，n.g未定义。即使得判断错误。在console调试得知n.g===window为true，即手动赋值n.g=window
                    try {
    ...
    return window.btoa(time)
};

console.log(MATCH_SDK_16(Date["parse"](new Date)["toString"]()));